        ...
        <body>
            <main class="sign-up">
                ...
                <div class="sign-up__content">
                    ...
                    <form action="getTelephonePaymentMode" method="post" class="sign-up__form form">
                        <div class="form__row ">
                            <div class="input">
                                <div class="input__container">
                                    <input class="input__field" type="text" name="bl" value="${Telephonenumber}" /><label
                                        class="input__label" for="mobilenumber">Mobile Number</label>
