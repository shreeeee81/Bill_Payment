...
<form:form  action="telegverify" method="post" modelAttribute="vergpay" style="margin-top:50px;">
<table>


<tr>
<td align="left" style="width:10rem;padding: 5px; margin-left: 0;">Telephone Number</td>
<td><input type="text" name="bil" value="${teleno}"></td>
</tr>
