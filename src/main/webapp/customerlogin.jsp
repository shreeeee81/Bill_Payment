		...
		<body>
			<main class="sign-up">
				...
				<div class="sign-up__content">
					...
					<form:form action="/cuslogin" method="post" modelAttribute="customer" class="sign-up__form form">
						<div class="form__row">
							<div class="input">
					...
					<div class="form__row sign-up__sign">
						New Customer? &nbsp;<a class="link" href="/customerregister">Sign Up</a>
					</div>
					
					<div class="form__row sign-up__sign">
						Forgot Password?  &nbsp;<a  class="link" href="/forgotcpassword">Click here</a>
					</div>
				</div>
