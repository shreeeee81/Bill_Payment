                                ...
                                <div class="sign-up__content">
                                        <header class="sign-up__header">
                                                ...
                                                <p class="sign-up__descr">
                                                        Please enter the Tele Details
                                                </p>
                                        </header>
                                        <form:form action="telephoneSave" method="post" modelAttribute="telephone"
                                                        ...
                                                        <div class="input">
                                                                <div class="input__container">
                                                                        <form:input required="required"
                                                                                ...
                                                                                placeholder="Mobile Number" /><label
                                                                                class="input__label"
                                                                                for="Telephonenumber">Mobile
                                                                                Number</label>
                                                                        <br>
