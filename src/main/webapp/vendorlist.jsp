...
<body>
	<main class="sign-up">
		...
		<br>
		<h5>
			<center>Activate/Deactivate Vendor</center>
		  </h5><br>
			...
			<tbody>
				<c:forEach items="${userList}" var="vendors_details">
					<tr>
						...
						<td><a href="activate?id=${vendors_details.username}"><button class="btn btn-success">Activate</button></a>&nbsp;<a href="deactivate?id=${vendors_details.username}"><button class="btn btn-danger">Deactivate</button></a></td>
